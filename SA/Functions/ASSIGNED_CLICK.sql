CREATE OR REPLACE FUNCTION sa.ASSIGNED_CLICK(
...
IS
   ...
   AND table_x_part_class_params.x_param_name = 'DEFAULT_CLICK_ID'
   AND to_number(x_param_value) = table_x_click_plan.objid
