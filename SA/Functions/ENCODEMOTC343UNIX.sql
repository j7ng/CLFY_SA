CREATE OR REPLACE FUNCTION sa.EncodeMotC343Unix
/*************************************************************************************/
/* NAME     :       EncodeMotC343Unix
/* PURPOSE  :       Called from sp_codegen for DLL:17
/*
/* REVISION  DATE        WHO             PURPOSE
/* --------  ---------- -----            ---------------------------------------------
/* 1.1       04/08/05   Gerald Pintado   Initial Release: New Function call for DLL:17
/*
/*
/*************************************************************************************/
(
...
GCODE_RETURN            OUT string)
  ...
  AS
     LANGUAGE C
    library LibEncodeMotoC343Unix

       name "code_generator_moto_c343_Unix"
          parameters (
          ESN              string,
          ICCID            string,
          SEQUENCE         DOUBLE,
