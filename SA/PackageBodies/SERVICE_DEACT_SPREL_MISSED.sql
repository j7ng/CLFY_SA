CREATE OR REPLACE PACKAGE BODY sa."SERVICE_DEACT_SPREL_MISSED"
AS
/********************************************************************************/
   ...
   BEGIN
      ...
      INSERT INTO table_x_call_trans
                  (objid, call_trans2site_part, x_action_type,
                   ...
                   x_call_trans2user, x_min, x_service_id, x_sourcesystem,
                   x_transact_date, x_total_units, x_action_text, x_reason,
                   x_result, x_sub_sourcesystem,           -- 07/05/2002 by SL
                                                x_iccid       -- 07/07/2004 GP
                  )
           VALUES (
                   -- call_trans_seq_rec.val,
                   v_ct_seq, ip_site_part, ip_action,
                   ip_carrier, ip_dealer,
                   ip_user, ip_min, ip_phone, ip_source,
                   ip_transdate, ip_units, ip_action_text, ip_reason,
                   ip_result,
...
/****************************************************/
   ...
   IS
      ...
      IS
         SELECT site_id
           FROM table_site
          WHERE objid = cust_site_objid_ip AND ROWNUM = 1;
      ...
      IS
         SELECT pn.x_manufacturer x_manufacturer
          ...
          WHERE pn.objid = ml.part_info2part_num AND ml.objid = ml_objid;
...
--cwl CR12874
         ...
         INSERT INTO table_address
                     (objid, address,
                      s_address, city,
                      s_city, state, s_state, zipcode, address_2, dev,
                      address2time_zone, address2country, address2state_prov,
                      update_stamp
                     )
              VALUES (v_new_address_objid, 'No Address Provided',
                      'NO ADDRESS PROVIDED', 'No City Provided',
                      'NO CITY PROVIDED', 'FL', 'FL', '33122', NULL, NULL,
                      268435561, 268435457, 268435466,
                      SYSDATE
                     );
         ...
         INSERT INTO table_site
                     (objid, site_id,
                      NAME, s_name, external_id, TYPE,
                      logistics_type, is_support, region, s_region, district,
                      s_district, depot, contr_login, contr_passwd,
                      is_default, notes, spec_consid, mdbk, state_code,
                      state_value, industry_type, appl_type, cut_date,
                      site_type, status, arch_ind, alert_ind, phone, fax,
                      dev, child_site2site, support_office2site,
                      cust_primaddr2address, cust_billaddr2address,
                      cust_shipaddr2address, site_support2employee,
                      site_altsupp2employee, report_site2bug,
                      primary2bus_org, site2exch_protocol,
                      dealer2x_promotion, x_smp_optional, update_stamp,
                      x_fin_cust_id
                     )
              VALUES (v_new_site_objid, 'IND' || TO_CHAR (v_new_site_id),
                      'No Address Provided', 'NO ADDRESS PROVIDED', NULL, 4,
                      0, 0, NULL, NULL, NULL,
                      NULL, NULL, NULL, NULL,
                      0, NULL, 0, NULL, 0,
                      NULL, NULL, NULL, TO_DATE ('01-JAN-1753'),
                      'INDV', 0, 0, 0, NULL, NULL,
                      NULL, NULL, NULL,
         ...
         INSERT INTO table_contact_role
                     (objid, role_name, s_role_name, primary_site, dev,
                      contact_role2site, contact_role2contact,
                      contact_role2gbst_elm, update_stamp
                     )
              VALUES (v_new_contact_role_objid, NULL, NULL, 1, NULL,
                      v_new_site_objid, v_new_contact_objid,
                      NULL, SYSDATE
                     );

         /** create a table_contact record **/
         INSERT INTO table_contact
                     (objid, first_name, s_first_name,
                      last_name, s_last_name, phone, fax_number,
                      e_mail, mail_stop, expertise_lev, title, hours,
                      salutation, mdbk, state_code, state_value, address_1,
                      address_2, city, state, zipcode, country, status,
                      arch_ind, alert_ind, dev, caller2user,
                      contact2x_carrier, x_cust_id, x_dateofbirth, x_gender,
                      x_middle_initial, x_mobilenumber, x_no_address_flag,
                      x_no_name_flag, x_pagernumber, x_ss_number,
                      x_no_phone_flag, update_stamp, x_new_esn,
                      x_email_status, x_html_ok
                     )
              VALUES (v_new_contact_objid, v_new_site_id, v_new_site_id,
                      v_new_site_id, v_new_site_id, v_new_site_id, NULL,
                      NULL, NULL, 0, NULL, NULL,
                      NULL, NULL, 0, NULL, 'No Address Provided',
                      NULL, 'No Address Provided', 'FL', '33122', 'USA', 0,
                      0, 0, NULL, NULL,
                      NULL, v_new_site_id, TO_DATE ('01-JAN-1753'), NULL,
                      NULL, NULL, 1,
                      1, NULL, NULL,
                      1, SYSDATE, NULL,
                      0, 0
      ...
      INSERT INTO x_monitor
                  (x_monitor_id, x_date_mvt,
                   x_phone, x_esn, x_cust_id,
                   x_carrier_id, x_dealer_id,
                   x_action,
                   x_reason_code, x_line_worked, x_line_worked_by,
                   x_line_worked_date, x_islocked, x_locked_by,
                   x_action_type_id, x_ig_status, x_ig_error,
                   x_pin, x_manufacturer, x_initial_act_date,
                   x_end_user,
                   x_msid                            --Number Pooling 10/18/02
                  )
           VALUES ((seq_x_monitor_id.NEXTVAL + (POWER (2, 28))), SYSDATE,
                   c1_rec.x_min, c1_rec.serial_no, c2_rec.site_id,
                   TO_CHAR (x_carrier_id), c3_rec.site_id,
                   DECODE (c1_rec.x_notify_carrier, 1, 'D', 0, 'S'),
                   c1_rec.x_deact_reason, NULL, NULL,
                   NULL, NULL, NULL,
                   DECODE (c1_rec.x_notify_carrier, 1, 0, 0, 1), NULL, NULL,
                   c1_rec.x_pin, c4_rec.x_manufacturer, c1_rec.install_date,
                   c5_rec.NAME,
...
/*******************************************************************************************/
   ...
   IS
      ...
      v_procedure_name   VARCHAR2 (80)
                             := v_package_name || '.SP_UPDATE_EXP_DATE_PRC()';

      CURSOR cur_ph_c (ip_esn VARCHAR2)
      IS
         SELECT *
   ...
   BEGIN
      ...
      SELECT COUNT (*)
        ...
        FROM table_part_inst
       WHERE part_serial_no = p_esn AND x_domain = 'PHONES';
      ...
      BEGIN
         ...
         INSERT INTO table_x_pi_hist
                     (objid, status_hist2x_code_table, x_change_date,
                      ...
                      x_pi_hist2carrier_mkt, x_pi_hist2inv_bin,
                      x_pi_hist2part_inst, x_pi_hist2part_mod,
                      x_pi_hist2user, x_pi_hist2x_new_pers,
                      x_pi_hist2x_pers, x_po_num,
                      x_reactivation_flag, x_red_code,
                      x_sequence, x_warr_end_date, dev,
              ...
              VALUES (
                      ...
                      -- seq('x_pi_hist'),
                      v_pi_hist_seq, rec_ph.status2x_code_table, SYSDATE,
                      'PROTECTION PLAN BATCH', rec_ph.x_cool_end_date,
                      ...
                      rec_ph.part_bin, '84', rec_ph.part_mod,
                      rec_ph.part_serial_no, rec_ph.part_status,
                      rec_ph.part_inst2carrier_mkt, rec_ph.part_inst2inv_bin,
                      rec_ph.objid, rec_ph.n_part_inst2part_mod,
                      rec_ph.created_by2user, rec_ph.part_inst2x_new_pers,
                      rec_ph.part_inst2x_pers, rec_ph.x_po_num,
                      rec_ph.x_reactivation_flag, rec_ph.x_red_code,
                      rec_ph.x_sequence, rec_ph.warr_end_date, rec_ph.dev,
...
--Get the record for the esn from table_x_autopay_details table
      CURSOR curgetdpp_c (ip_esn IN VARCHAR2)
      IS
         SELECT *
      ...
      op_msg             VARCHAR2 (50);
      v_procedure_name   VARCHAR2 (80)
                            := v_package_name || '.CHECK_DPP_REGISTERED_PRC()';
      dayval             VARCHAR2 (30);
---for CR 1142
   BEGIN
         ...
         THEN
            ...
            BEGIN
               ...
               INSERT INTO x_send_ftp_auto
                           (send_seq_no, file_type_ind, esn,
                            debit_date,
                            program_type, account_status,
                            amount_due
                           )
                    VALUES (seq_x_send_ftp_auto.NEXTVAL, 'D', p_esn,
                            DECODE (dayval,
                                    'FRIDAY', SYSDATE + 3,
                                    'SATURDAY', SYSDATE + 2,
                                    SYSDATE + 1
                                   ),                               -- CR 1142
                            curgetdpp_rec.x_program_type, 'A',
...
/******************************************************************************/
   ...
   EXCEPTION
      ...
      THEN
         err_no :=
            toss_util_pkg.insert_error_tab_fun
...
/*******************************************************************************************/
   PROCEDURE remove_autopay_prc (p_esn IN VARCHAR2, out_success OUT NUMBER)
   IS
      v_prg_type         NUMBER;
      v_cycle_number     NUMBER;
      v_cust_name        VARCHAR2 (45);
      v_procedure_name   VARCHAR2 (80)
                                     := v_package_name || '.REMOVE_AUTOPAY()';

------------------------------------------------------------
      CURSOR curautoinfo_c (c_esn VARCHAR2)
      IS
         SELECT *
           FROM table_x_autopay_details
          WHERE x_esn = c_esn
      ...
      THEN
         ...
         INSERT INTO table_x_call_trans
              ...
              VALUES (
                      ...
                      -- seq('x_call_trans'),
                      v_call_trans_seq, site_part_rec.objid, '83',
         ...
         IF site_part_rec.x_deact_reason IN
               ('NO NEED OF PHONE',
                'PAST DUE',
                'PASTDUE',
                'SALE OF CELL PHONE',
         ...
         THEN
            ...
            INSERT INTO x_send_ftp_auto
                        (send_seq_no, file_type_ind, esn,
                         program_type, account_status, amount_due
                        )
                 VALUES (seq_x_send_ftp_auto.NEXTVAL, 'D', p_esn,
                         curautoinfo_rec.x_program_type, 'D', 0
                        );
         ELSE
            INSERT INTO x_autopay_pending
                        (objid,
                         ...
                         x_autopay_details2contact, x_source_flag,
                         x_enroll_amount,
                         x_source,
                         x_language_flag,
                         x_payment_type
                        )
                 VALUES (curautoinfo_rec.objid,
                         ...
                         curautoinfo_rec.x_start_date, SYSDATE,
                         ...
                         curautoinfo_rec.x_autopay_details2contact, 'D',
...
--EME_080505 Starts
   ...
   IS
      ...
      v_action           VARCHAR2 (50)
                                 := 'x_service_id is null in Table_site_part';
      ...
      IS
         SELECT sp.objid site_part_objid, sp.x_service_id x_service_id,
                ...
                pi.objid esnobjid, sp.x_msid,
                pi.part_serial_no part_serial_no, pi.x_iccid,
                pn.x_ota_allowed
   ...
   BEGIN
      ...
      LOOP
         ...
         ELSE
            ...
            END IF;
            END IF;  -- End Billing_deactprotect
            --------------------------------------------------------------------------------------------------
...
/*****************************************************************************/
   ...
   IS
      ...
      IS
         SELECT   sp.objid site_part_objid, sp.x_service_id x_service_id,
                  sp.x_min x_min, ca.objid carrier_objid,
                  ir.inv_role2site site_objid, ca.x_carrier_id x_carrier_id,
                  sp.site_objid cust_site_objid, sp.x_msid, pi.x_iccid
             FROM table_x_carrier ca,
                  table_part_inst pi2,
                  table_inv_role ir,
                  table_inv_bin ib,
...
--VAdapa on 02/13/02 to deactivate expired ROADSIDE cards
   ...
   IS
      ...
      CURSOR c_road_inst (c_ip_ser_id IN VARCHAR2)
      IS
         SELECT *
         ...
         BEGIN
            ...
            INSERT INTO table_x_road_hist
                        (objid, x_part_serial_no,
                         x_part_mod, x_part_bin,
                         x_warr_end_date, x_part_status,
                         x_insert_date,
                         x_creation_date, x_po_num,
                         x_domain, x_part_inst_status, x_change_date,
                         x_change_reason, x_last_trans_time,
                         x_transaction_id, x_repair_date,
                         x_pick_request, x_order_number,
                         x_road_hist2inv_bin,
                         x_road_hist2part_mod, x_road_hist2road_inst,
                         x_road_hist2user, road_hist2x_code_table,
                         x_road_hist2site_part
                        )
                 VALUES (
                         -- 04/10/03 seq_x_road_hist.nextval + POWER (2, 28),
                         -- seq('x_road_hist'),
                         v_road_hist_seq, r_road_inst.part_serial_no,
                         r_road_inst.part_mod, r_road_inst.part_bin,
                         r_road_inst.warr_end_date, r_road_inst.part_status,
                         r_road_inst.x_insert_date,
                         r_road_inst.x_creation_date, r_road_inst.x_po_num,
                         r_road_inst.x_domain, '47', SYSDATE,
                         'PASTDUE', SYSDATE,
                         r_road_inst.transaction_id, r_road_inst.repair_date,
                         NULL, r_road_inst.x_order_number,
                         r_road_inst.road_inst2inv_bin,
                         r_road_inst.n_road_inst2part_mod, r_road_inst.objid,
                         r_road_inst.rd_create2user, 2144,
...
--CR#4479 - Billing Platform change request  ----end
      ...
      IS
         SELECT sp.objid site_part_objid, sp.x_service_id x_service_id,
                ...
                ir.inv_role2site site_objid, sp.serial_no x_esn,
                ca.x_carrier_id x_carrier_id, sp.site_objid cust_site_objid,
                pi.objid esnobjid, sp.x_msid, pi2.x_port_in, pi.x_iccid
           FROM table_x_carrier ca,
                table_part_inst pi2,
                table_inv_role ir,
                table_inv_bin ib,
...
-----------------------------------------------------------------------------------------
            ...
            IF     c1_rec.x_port_in = 1
               AND ip_caller_program NOT LIKE
                                             '%MANUAL REFURB.RESET_ESN_FUN()%'
...
-- Billing rules engine call for any deactivation
			...
			billing_deact_rule_engine (ip_esn,ip_reason,v_user,op_result,op_msg );
...
/***********************************************************************************/
   ...
   IS
      CURSOR cur_ph
      IS
         SELECT a.*, c.x_technology,
                NVL (c.x_restricted_use, 0) x_restricted_use,
                e.objid siteobjid, f.x_notify_carrier, f.objid sitepartobjid,
                f.x_service_id, f.x_min, f.install_date,
                f.site_part2x_new_plan, f.site_part2x_plan
          ...
          WHERE a.x_part_inst2site_part = f.objid
            ...
            AND a.x_part_inst_status =
                   DECODE (ip_deactreason,
                           'SENDCARRDEACT', a.x_part_inst_status,
                           '52'
                          )
...
-------------------------------------------------------
      ...
      IS
         SELECT objid, part_serial_no, part_inst2carrier_mkt, x_port_in,
                x_part_inst_status, x_npa, x_nxx, x_ext
           FROM table_part_inst
          WHERE part_serial_no = c_min AND x_domain = 'LINES';
...
-------------------------------------------------------
      ...
      IS
         SELECT b.*
          ...
          WHERE DECODE (c_tech,
                        'GSM', a.carrier2rules_gsm,                  -- CR4579
...
-------------------------------------------------------
      CURSOR currdeactcode (c_deactreason IN VARCHAR2, c_deacttype IN VARCHAR2)
      IS
         SELECT *
           FROM table_x_code_table
          WHERE x_code_name = c_deactreason AND x_code_type = c_deacttype;

      recdeactcode         currdeactcode%ROWTYPE;

-------------------------------------------------------
      CURSOR currstatcode (c_statcode IN VARCHAR2, c_codetype IN VARCHAR2)
      IS
         SELECT *
           FROM table_x_code_table
          WHERE x_code_number = c_statcode AND x_code_type = c_codetype;
...
/***** CR4245 - ILD *********/
      ...
      IS
         SELECT 'X'
          ...
          WHERE x_ota_features2part_inst = (SELECT objid
                                              FROM table_part_inst
      ...
      CURSOR c_carr_parent (c_min IN VARCHAR2)
      IS
         SELECT table_x_parent.*
           FROM table_x_carrier, table_x_carrier_group, table_x_parent
          WHERE table_x_carrier.carrier2carrier_group =
                                                   table_x_carrier_group.objid
            AND table_x_carrier_group.x_carrier_group2x_parent =
                                                          table_x_parent.objid
	...
	--CR#4479 - Billing Platform change request  ----end
      ...
      --CR5538 Begin
      int_reserve_flag     table_x_carrier_rules.x_reserve_on_suspend%TYPE
                                                                          := 0;
   ...
   BEGIN
      ...
      ELSE
         ...
         THEN                    --Verizon 45 days cooling affecting upgrades
            blnupgcooling := TRUE;
         END IF;
      ...
      OPEN currcarrierrules (rec_min.part_inst2carrier_mkt,
                             rec_ph.x_technology
                            );                                       -- CR4579
...
--         IF (v_deactreason = 'SIM DAMAGE')
         IF (v_deactreason IN ('SIM DAMAGE', 'UPGRADE', 'ACTIVE UPGRADE')
            )                                                         --CR5202
         THEN
...
-- Added for CR3667
      ...
      THEN
            ...
            LOOP
               ...
               UPDATE table_x_account_hist
                ...
                WHERE account_hist2part_inst = recreservedmin.objid
                  AND (   x_end_date IS NULL
                       OR x_end_date =
                                  TRUNC (TO_DATE ('01/01/1753', 'MM/DD/YYYY'))
                      );

               COMMIT;

               IF writepihistory (ip_userobjid,
                                  recreservedmin.part_serial_no,
                                  rec_min.x_npa,
                                  rec_min.x_nxx,
                                  rec_min.x_ext,
                                  'DEACTIVATE',
         ...
         THEN
            ...
            IF NOT (blnstart) AND intportin != 2
            THEN
            ...
            LOOP
               ...
               UPDATE table_part_inst
                  SET x_part_inst_status = recdeactcode.x_code_number,
                      status2x_code_table = recdeactcode.objid,
                      x_cool_end_date =
                         DECODE (intcoolingperiod,
                                 0, x_cool_end_date,
                                 SYSDATE + intcoolingperiod
                                )
                WHERE objid = recreservedmin.objid;
      ...
      IF (LENGTH (ip_newesn) >= 11 AND ip_samemin = 'true')
      THEN
         --CR3200
 ...
 --ricky's emergency'
      IF ip_deactreason = 'SENDCARRDEACT'
      THEN
         intgsmgraceperiod := -5;
      END IF;
dbms_output.put_line('######### intgsmgraceperiod:'||intgsmgraceperiod);
dbms_output.put_line('######### rec_ph.x_technology:'||rec_ph.x_technology);
dbms_output.put_line('######### ip_deactreason:'||ip_deactreason);
      --ricky's emergency'
      UPDATE table_part_inst
         SET x_part_inst_status = recdeactcode.x_code_number,
             status2x_code_table = recdeactcode.objid,
             ...
             warr_end_date =
                DECODE (intusedlnexdays,
                        0, TO_DATE ('01/01/1753', 'mm/dd/yyyy'),
                        SYSDATE + intusedlnexdays
                       ),
             last_trans_time = SYSDATE,
             repair_date = DECODE (intnewesn, 1, SYSDATE, repair_date),
             part_inst2x_pers =
                DECODE (part_inst2x_new_pers,
                        NULL, part_inst2x_pers,
             ...
             x_port_in =
                DECODE (ip_samemin,
                        'true', intportin,
                        (DECODE (intportin, 2, 0, intportin)
                        )
                       )                                            --CR3327-1
      ...
      UPDATE table_site_part
         SET service_end_dt = SYSDATE,
             x_expire_dt=  --CR6151; added column update + case statement
               case when v_deactreason in ('UPGRADE' ,'ACTIVE UPGRADE','WAREHOUSE PHONE') then
                 sysdate else
                 x_expire_dt
               end,
...
--------------------------------------------------------------------------------------------------
      ...
      create_call_trans (rec_ph.sitepartobjid,
                         2,
...
--CR5566
      ...
      UPDATE table_part_inst
         SET x_part_inst_status = recphstatcode.x_code_number,
             ...
             last_trans_time = SYSDATE,
             x_reactivation_flag =
                      DECODE (recdeactcode.x_value,
                              2, 1,
                              x_reactivation_flag
                             ),
             part_inst2x_new_pers = NULL,
             x_clear_tank =
                    DECODE (v_expireminutes,
                            1, v_expireminutes,
                            x_clear_tank
                           )
       WHERE x_part_inst_status = '52' AND objid = rec_ph.objid;
...
--CR5566
      ...
      THEN
         ...
         END IF;
      ELSE
         IF (int_deac_flag = 1) AND (ip_samemin = 'RETURNMIN')
         THEN                                                        --CR5538
            strdeacttype := 'Deactivation';
         ELSE
            IF (intportin = 1)
...
--          THEN
         ...
         THEN
            ...
            THEN
               op_returnmsg :=
                             op_returnmsg || ' No x_call_trans record found.';
         ...
         UPDATE sa.x_free_voice_mail
          ...
          WHERE x_fvm_status = 2 AND free_vm2part_inst = rec_ph.objid;
         ...
         LOOP
            ...
            INSERT INTO table_x_group_hist
                 ...
                 VALUES (intgrphistseq, reccurremovepromo.x_start_date,
                         reccurremovepromo.x_end_date, SYSDATE, 'REMOVE',
         ...
         UPDATE    table_x_ota_transaction a
               SET x_status = 'COMPLETED',
                   x_reason = 'DEACT'
             WHERE x_status = 'OTA PENDING' AND x_esn = ip_esn
...
-- 06/09/03
   BEGIN
      ...
      INSERT INTO table_x_pi_hist
           ...
           VALUES (v_pi_hist_seq, table_part_inst_rec.status2x_code_table,
                   ...
                   table_part_inst_rec.n_part_inst2part_mod, ip_userobjid,
                   ...
                   table_part_inst_rec.x_msid, ip_iccid
                  );
   ...
   EXCEPTION
      ...
      THEN
         toss_util_pkg.insert_error_tab_proc
                                          ('Failer inserting swipe',
                                           ip_part_serial_no,
                                           'TOSS_UTIL_PKG.INSERT_PI_HIST_FUN'
                                          );
         RETURN 0;
   END;
END  Service_deact_sprel_missed;
/