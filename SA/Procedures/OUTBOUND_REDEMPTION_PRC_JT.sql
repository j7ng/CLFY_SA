CREATE OR REPLACE PROCEDURE sa.OUTBOUND_REDEMPTION_PRC_JT(l_red_code in varchar2)
AS
p_red_code   VARCHAR2(20) := l_red_code;
   CURSOR red_card_cur
   IS
...
IS
 ...
 and rownum < 2 -- FOR TESTING ONLY
   ...
   --CR5183 end
   l_procedure_name     CONSTANT VARCHAR2 (80) := 'outbound_redemption_prc_jt';
...
EXCEPTION
   ...
   THEN
      ...
      THEN
         COMMIT;
      END IF;
END outbound_redemption_prc_jt;
/