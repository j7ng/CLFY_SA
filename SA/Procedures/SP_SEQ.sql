CREATE OR REPLACE PROCEDURE sa."SP_SEQ" (p_seq_name VARCHAR2, p_objid OUT NUMBER)
IS
/***********************************************************************************/
...
/***********************************************************************************/
   ...
   v_program_name      VARCHAR2 (50)         := 'sp_seq';           --01/10/05
