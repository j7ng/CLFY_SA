CREATE OR REPLACE procedure sa.INSERT_LINE_Prc (
                         ...
                         op_min          OUT     VARCHAR2,
                         op_line_objid       OUT     NUMBER,
                         op_call_trans_objid             out number,
                         op_site_objid             out number,
                         op_sitepart_objid out number,
                         op_ota_trans_objid out number)
IS
...
if  v_bus_org='TRACFONE' or v_bus_org='NET10'  then
