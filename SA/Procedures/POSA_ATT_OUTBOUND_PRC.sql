CREATE OR REPLACE PROCEDURE sa."POSA_ATT_OUTBOUND_PRC"
AS

 --********************************************************************************
 --$RCSfile: POSA_ATT_OUTBOUND_PRC.sql,v $
 --$Revision: 1.2 $
 --$Author: skota $
 --$Date: 2015/10/02 17:27:13 $
 --$ $Log: POSA_ATT_OUTBOUND_PRC.sql,v $
 --$ Revision 1.2  2015/10/02 17:27:13  skota
 --$ modified for ofs not sync with clarify
 --$
/******************************************************************************/
/*    Copyright ) 2001 Tracfone  Wireless Inc. All rights reserved            */
/*                                                                            */
/* NAME:         SA.POSA_ATT_OUTBOUND_PRC (formerly prefixed by sp)           */
/* PURPOSE:                                                                   */
/* FREQUENCY:                                                                 */
...
/******************************************************************************/
   ...
   IS
      SELECT pac.*, pac.ROWID
       ...
       ORDER BY objid,tf_serial_num, toss_posa_date; --added objid CR37189 to sync the latest status code
   ...
   v_procedure_name VARCHAR2 (80) := 'POSA_ATT_OUTBOUND_PRC';
