CREATE OR REPLACE PACKAGE sa.SERVICE_DEACTIVATION_CODE_jt AS
/********************************************************************************/
...
/*  1.5  09/27/2011 CL  CR18207 Fix ST deact job to work faster in the          */
/*                      deact_past_due_proc                                     */
/********************************************************************************/
--
--
...
/* Assumption:                                                                */
/******************************************************************************/
    PROCEDURE DEACTIVATE_PAST_DUE(p_bus_org_id    IN VARCHAR2,v_esn    in varchar2);
--
--
/******************************************************************************/
/*                                                                            */
 ...
 *******************************************/
 FUNCTION get_amount_fun (p_prg_type IN NUMBER )
 RETURN NUMBER;
--
--
 /*****************************************************************************/
...
PROCEDURE sendcarrdeact ( l_min   IN   VARCHAR2);
--
--
...
--
  ...
  /***********************************************************************************/
 FUNCTION get_deact_line_status (ip_ph_tech     VARCHAR2,
                                 ip_min         VARCHAR2,
                                 ip_deactreason VARCHAR2)
 RETURN VARCHAR2;
--
