CREATE OR REPLACE FORCE VIEW sa.x_job_pending_activations_tc (job_objid,job_title,x_old_esn,x_esn,x_min,x_program_objid,x_iccid,x_zip,case_objid,x_contact_objid) AS
