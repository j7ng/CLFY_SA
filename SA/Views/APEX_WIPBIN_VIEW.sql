CREATE OR REPLACE FORCE VIEW sa.apex_wipbin_view (w_objid,q_objid,id_number,title,age,carrier_id,carrier_name,esn,"CONDITION",status,"PRIORITY",severity,creation_time) AS
select /*+ FIRST_ROWS(250) */
        c.case_wip2wipbin w_objid,
 ...
 and    c.case_wip2wipbin is not null
