...
select table_N_Option.objid, table_N_Option.objid,
 ...
 table_price_prog.objid, table_N_Option.N_ImageURL,
 table_part_num.domain, table_part_num.S_domain
 from table_mod_level table_p_ml, table_N_Option, table_part_num, table_price_qty,
  table_price_prog, table_price_inst
 where table_price_prog.objid = table_price_inst.price_inst2price_prog
 AND table_p_ml.objid = table_N_Option.N_Option2mod_level
