CREATE OR REPLACE FORCE VIEW sa.table_cas_contr_prog (objid,title,response_time,units_used,units_avail,parent_objid,unit_measure,description,s_description,prog_name,s_prog_name,quantity,start_date,end_date,resp,ent_objid,units_purch,biz_cal_objid,part_num_objid,line_no_txt) AS
select table_next_contr.objid, table_biz_cal.title,
 ...
 table_next_contr.units_purch, table_biz_cal.objid,
 table_part_num.objid, table_next_contr.line_no_txt
 ...
 AND table_mod_level.objid = table_next_contr.contr_itm2mod_level
