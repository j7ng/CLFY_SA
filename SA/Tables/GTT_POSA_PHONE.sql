CREATE GLOBAL TEMPORARY TABLE sa.gtt_posa_phone (
  ...
  CONSTRAINT pk_gtt_posa_phone PRIMARY KEY (objid)
)
ON COMMIT PRESERVE ROWS;
COMMENT ON TABLE sa.gtt_posa_phone IS 'Global Temporary table to hold a posa phone dummy record';