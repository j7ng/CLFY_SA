CREATE TABLE sa.upd_table_site_part (
  objid NUMBER,
...
ALTER TABLE sa.upd_table_site_part ADD SUPPLEMENTAL LOG GROUP dmtsora1437186894_0 (bin_objid, comments, dev, dir_site_objid, install_date, instance_name, inst_objid, invoice_no, level_to_bin, level_to_part, machine_id, mdbk, modified, objid, part_status, quantity, selected_prd, serial_no, service_end_dt, ship_date, site_objid, state_code, state_value, s_serial_no, warranty_date, x_deact_reason, x_expire_dt, x_min, x_min_change_flag, x_notify_carrier, x_pin, x_service_id, x_zipcode) ALWAYS;
ALTER TABLE sa.upd_table_site_part ADD SUPPLEMENTAL LOG GROUP dmtsora1437186894_1 (all_site_part2site, site_part2backup, site_part2part_detail, site_part2part_info, site_part2primary, site_part2productbin, site_part2site, site_part2site_part, site_part2x_new_plan, site_part2x_plan, x_msid, x_refurb_flag) ALWAYS;