CREATE TABLE sa.x_cingular_mrkt_info_bak (
...
ALTER TABLE sa.x_cingular_mrkt_info_bak ADD SUPPLEMENTAL LOG GROUP dmtsora1435921022_0 (account_num, dealer_code, market_code, mkt, mkt_type, npa, npanxx, nxx, rc_name, rc_number, rc_state, submarketid, "TEMPLATE", zip) ALWAYS;