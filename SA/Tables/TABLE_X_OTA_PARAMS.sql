CREATE TABLE sa.table_x_ota_params (
  objid NUMBER,
...
ALTER TABLE sa.table_x_ota_params ADD SUPPLEMENTAL LOG GROUP dmtsora168823982_0 (objid, x_act_enabled, x_ba_pin_required, x_ba_promo_on, x_buy_airtime_enabled, x_ild_counter, x_max_feature_count, x_message_response, x_mo_enabled, x_mt_enabled, x_react_enabled, x_redm_enabled, x_refill_count, x_refill_training, x_sim_req, x_source_system, x_start_date) ALWAYS;