...
ALTER TABLE sa.x_monitor ADD SUPPLEMENTAL LOG GROUP dmtsora1324434231_0 (x_action, x_action_type_id, x_carrier_id, x_cust_id, x_date_mvt, x_dealer_id, x_end_user, x_esn, x_fax_filename, x_ig_error, x_ig_status, x_initial_act_date, x_islocked, x_line_worked, x_line_worked_by, x_line_worked_date, x_locked_by, x_manufacturer, x_monitor_id, x_msid, x_phone, x_pin, x_reason_code) ALWAYS;