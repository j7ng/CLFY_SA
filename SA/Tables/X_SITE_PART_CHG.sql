CREATE TABLE sa.x_site_part_chg (
  objid NUMBER,
  ...
  x_update_date DATE,
  x_condition VARCHAR2(50 BYTE),
  x_action VARCHAR2(10 BYTE)
);
ALTER TABLE sa.x_site_part_chg ADD SUPPLEMENTAL LOG GROUP dmtsora676507283_0 (bin_objid, comments, dev, dir_site_objid, install_date, instance_name, inst_objid, invoice_no, level_to_bin, level_to_part, machine_id, mdbk, modified, objid, part_status, quantity, selected_prd, serial_no, service_end_dt, ship_date, site_objid, state_code, state_value, s_serial_no, warranty_date, x_deact_reason, x_expire_dt, x_min, x_min_change_flag, x_notify_carrier, x_pin, x_service_id, x_zipcode) ALWAYS;
ALTER TABLE sa.x_site_part_chg ADD SUPPLEMENTAL LOG GROUP dmtsora676507283_1 (all_site_part2site, site_part2backup, site_part2part_detail, site_part2part_info, site_part2primary, site_part2productbin, site_part2site, site_part2site_part, site_part2x_new_plan, site_part2x_plan, x_action, x_condition, x_msid, x_refurb_flag, x_update_date) ALWAYS;