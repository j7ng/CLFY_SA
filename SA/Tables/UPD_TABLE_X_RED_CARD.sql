CREATE TABLE sa.upd_table_x_red_card (
  objid NUMBER,
...
ALTER TABLE sa.upd_table_x_red_card ADD SUPPLEMENTAL LOG GROUP dmtsora1777630155_0 (objid, red_card2call_trans, red_smp2inv_smp, red_smp2x_pi_hist, x_access_days, x_created_by2user, x_inv_insert_date, x_last_ship_date, x_order_number, x_po_num, x_red_card2inv_bin, x_red_card2part_mod, x_red_code, x_red_date, x_red_units, x_result, x_smp, x_status) ALWAYS;