CREATE TABLE sa.x_cingular_mrkt_info_b (
...
ALTER TABLE sa.x_cingular_mrkt_info_b ADD SUPPLEMENTAL LOG GROUP dmtsora693628949_0 (account_num, dealer_code, market_code, mkt, mkt_type, npa, npanxx, nxx, rc_name, rc_number, rc_state, submarketid, "TEMPLATE", zip) ALWAYS;