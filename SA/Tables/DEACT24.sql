...
ALTER TABLE sa.deact24 ADD SUPPLEMENTAL LOG GROUP dmtsora1820002560_0 (ac_x_acct_num, ah_account_hist2x_account, cd_x_code_name, cellpi_x_insert_date, cn_first_name, cn_last_name, cn_phone, cn_x_cust_id, cr_contact_role2contact, ct_call_trans2site_part, ct_objid, ct_x_call_trans2user, ct_x_min, ct_x_reason, ct_x_service_id, ct_x_sourcesystem, ct_x_transact_date, custsite_cust_primaddr2address, custsite_objid, esnib_bin_name, esnpi_n_part_inst2part_mod, esnpi_part_inst2inv_bin, esnpi_x_po_num, esnst_name, esnst_objid, esnst_site_id, objid, sp_install_date, sp_objid, sp_site_part2site, sp_site_part2x_plan, sp_state_value, sp_x_zipcode) ALWAYS;
ALTER TABLE sa.deact24 ADD SUPPLEMENTAL LOG GROUP dmtsora1820002560_1 (ca_carrier2carrier_group, ca_objid, ca_x_act_analog, ca_x_act_technology, ca_x_carrier2address, ca_x_carrier_id, ca_x_mkt_submkt_name, ca_x_react_analog, ca_x_react_technology, cellpi_objid, cellpi_part_inst2carrier_mkt, cellpi_part_inst2x_pers, cgadd_address, cgadd_address_2, cgadd_city, cgadd_state, cgadd_zipcode, cg_objid, cg_x_carrier_group_id, cg_x_carrier_name, cg_x_group2address, cmadd_address, cmadd_address_2, cmadd_city, cmadd_state, cmadd_zipcode, esnml_part_info2part_num, esnpn_description, esnpn_objid, esnpn_part_number, esnpn_x_technology, us_login_name, us_objid) ALWAYS;
ALTER TABLE sa.deact24 ADD SUPPLEMENTAL LOG GROUP dmtsora1820002560_2 (custadd_address, custadd_address_2, custadd_city, custadd_state, custadd_zipcode, em_first_name, em_last_name) ALWAYS;