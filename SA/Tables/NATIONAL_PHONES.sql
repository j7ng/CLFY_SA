CREATE TABLE sa.national_phones (
  objid NUMBER,
...
ALTER TABLE sa.national_phones ADD SUPPLEMENTAL LOG GROUP dmtsora1366296046_1 (created_by2user, dtl2part_inst, eco_new2part_inst, fulfill2demand_dtl, hdr_ind, n_part_inst2part_mod, part_inst2carrier_mkt, part_inst2inv_bin, part_inst2x_new_pers, part_inst2x_pers, part_to_esn2part_inst, status2x_code_table, x_ext, x_ld_processed, x_order_number, x_part_inst2site_part) ALWAYS;
ALTER TABLE sa.national_phones ADD SUPPLEMENTAL LOG GROUP dmtsora1366296046_0 (bad_res_qty, date_in_serv, dev, good_res_qty, last_cycle_ct, last_mod_time, last_pi_date, last_trans_time, next_cycle_ct, objid, part_bad_qty, part_bin, part_good_qty, part_mod, part_serial_no, part_status, pick_request, pi_tag_no, repair_date, transaction_id, warr_end_date, x_cool_end_date, x_creation_date, x_deactivation_flag, x_domain, x_insert_date, x_npa, x_nxx, x_part_inst_status, x_po_num, x_reactivation_flag, x_red_code, x_sequence) ALWAYS;