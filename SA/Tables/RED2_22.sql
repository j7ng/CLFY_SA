...
ALTER TABLE sa.red2_22 ADD SUPPLEMENTAL LOG GROUP dmtsora1475581957_0 (cn_first_name, cn_last_name, cn_phone, cn_x_cust_id, cr_contact_role2contact, custadd_address, custadd_address_2, custadd_city, custadd_state, custadd_zipcode, custsite_cust_primaddr2address, objid, sp_install_date, sp_objid, sp_site_part2site, sp_site_part2x_plan, sp_state_value, sp_x_zipcode) ALWAYS;