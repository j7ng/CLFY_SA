CREATE TABLE sa.monitor_err (
  ...
  s_x_ig_error VARCHAR2(80 BYTE),
  error_text VARCHAR2(2000 BYTE)
);
ALTER TABLE sa.monitor_err ADD SUPPLEMENTAL LOG GROUP dmtsora238760116_0 (error_text, s_monitor_id, s_x_action, s_x_action_type_id, s_x_carrier_id, s_x_cust_id, s_x_date_mvt, s_x_dealer_id, s_x_end_user, s_x_esn, s_x_ig_error, s_x_ig_status, s_x_initial_act_date, s_x_line_worked, s_x_line_worked_by, s_x_line_worked_date, s_x_manufacturer, s_x_phone, s_x_pin, s_x_reason_code) ALWAYS;