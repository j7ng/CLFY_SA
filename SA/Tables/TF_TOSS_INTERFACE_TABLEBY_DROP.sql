CREATE TABLE sa.tf_toss_interface_tableby_drop (
...
ALTER TABLE sa.tf_toss_interface_tableby_drop ADD SUPPLEMENTAL LOG GROUP dmtsora675854336_0 (created_by, creation_date, ff_receive_date, last_updated_by, last_update_date, retailer_ship_date, serial_invalid_date, serial_valid_insert_date, tf_card_pin_num, tf_ff_location_code, tf_manuf_location_code, tf_manuf_location_name, tf_order_num, tf_part_num_parent, tf_part_num_transpose, tf_part_type, tf_po_num, tf_ret_location_code, tf_serial_num, toss_extract_date, toss_extract_flag, toss_redemption_code, transceiver_num) ALWAYS;