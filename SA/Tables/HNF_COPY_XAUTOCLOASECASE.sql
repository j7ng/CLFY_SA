CREATE TABLE sa.hnf_copy_xautocloasecase (
...
ALTER TABLE sa.hnf_copy_xautocloasecase ADD SUPPLEMENTAL LOG GROUP dmtsora1604717931_0 (x_activation_date, x_activation_zip_code, x_agent_name, x_carrier_id, x_carrier_name, x_case_title, x_case_type, x_contact_first_name, x_contact_last_name, x_create_date, x_cust_id, x_esn, x_flow_type, x_msid, x_phone_model, x_prl, x_red_code, x_retailer, x_soc) ALWAYS;