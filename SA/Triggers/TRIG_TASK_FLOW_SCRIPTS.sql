CREATE OR REPLACE TRIGGER sa."TRIG_TASK_FLOW_SCRIPTS"
BEFORE INSERT OR UPDATE OR DELETE
ON sa.ADFCRM_TASK_FLOW_SCRIPTS REFERENCING OLD AS OLD NEW AS NEW FOR EACH ROW
DECLARE
    v_changed_date date;
...
if deleting or (updating and (:old.tfs_id != :new.tfs_id or
...
then
      ...
      insert into sa.adfcrm_task_flow_scripts_hist
      (tfs_id
      ,task_id
      ,step
      ,script_type
