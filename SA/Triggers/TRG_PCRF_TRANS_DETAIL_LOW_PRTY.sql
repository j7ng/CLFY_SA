CREATE OR REPLACE TRIGGER sa.trg_pcrf_trans_detail_low_prty BEFORE INSERT OR UPDATE ON sa.x_pcrf_trans_detail_low_prty REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
 --------------------------------------------------------------------------------------------
